...
int ksu_init_symbols(void)
{
    ...
    /* Additional policydb & SID functions */
    ksu_syms.policydb_load_isids = (void *)ksu_lookup_name_unrestricted("policydb_load_isids");
    ksu_syms.policydb_destroy = (void *)ksu_lookup_name_unrestricted("policydb_destroy");
    ksu_syms.policydb_write = (void *)ksu_lookup_name_unrestricted("policydb_write");
    ksu_syms.policydb_read = (void *)ksu_lookup_name_unrestricted("policydb_read");
    ksu_syms.avtab_alloc = (void *)ksu_lookup_name_unrestricted("avtab_alloc");
    ksu_syms.avtab_destroy = (void *)ksu_lookup_name_unrestricted("avtab_destroy");
    ksu_syms.sidtab_destroy = (void *)ksu_lookup_name_unrestricted("sidtab_destroy");
    ksu_syms.avc_has_perm = (void *)ksu_lookup_name_unrestricted("avc_has_perm");
    ksu_syms.security_context_to_sid = (void *)ksu_lookup_name_unrestricted("security_context_to_sid");
    ksu_syms.security_sid_to_context = (void *)ksu_lookup_name_unrestricted("security_sid_to_context");
    ksu_syms.security_context_str_to_sid = (void *)ksu_lookup_name_unrestricted("security_context_str_to_sid");
    ksu_syms.security_compute_av_user = (void *)ksu_lookup_name_unrestricted("security_compute_av_user");

    /* Process & UID helpers */
    ksu_syms.alloc_uid = (void *)ksu_lookup_name_unrestricted("alloc_uid");
    ksu_syms.change_pid = (void *)ksu_lookup_name_unrestricted("change_pid");

    /* Memory/fixmap/mm helpers */
    ksu_syms.init_mm = (void *)ksu_lookup_name_unrestricted("init_mm");
    ksu_syms.__set_fixmap = (void *)ksu_lookup_name_unrestricted("__set_fixmap");
    ksu_syms.copy_to_kernel_nofault = (void *)ksu_lookup_name_unrestricted("copy_to_kernel_nofault");

    /* Symbol lookup helpers */
    ksu_syms.kallsyms_lookup = (void *)ksu_lookup_name_unrestricted("kallsyms_lookup");
    ksu_syms.kallsyms_lookup_size_offset = (void *)ksu_lookup_name_unrestricted("kallsyms_lookup_size_offset");
